...
namespace ConApp
{
    class Menu
    {
        ...
        /// </summary>
        /// <returns></returns>
        public LoginModel ReadLoginData()
        {
            Console.WriteLine("\nEnter Email address..\n");
            ...
            _loginModel.EmailAddress = _emailAddress;
        ...
        /// </summary>
        /// <returns></returns>
        public RegistrationModel ReadRegisterData()
        {
            Console.WriteLine("\nEnter First Name");
            ...
            _registrationModel.FirstName = _firstName;
            _registrationModel.LastName = _lastName;
            _registrationModel.EmailAddress = _emailAddress;
            _registrationModel.Password = _password;
            _registrationModel.ConfirmPassword = _confirmPassword;
            _registrationModel.IsStudent = _isStudent;
