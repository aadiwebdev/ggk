namespace Domain.StringLiterals
{
    public static class StringLiterals
    {
        ...
        public  static string _connectionString = "server =GGKU4MPC99;Initial Catalog =aditya369;Integrated Security = SSPI";
        ...
        public static string _validateLoginQuery = "SELECT * FROM UserInfo WHERE EmailAddress = @EmailAddress and Password = @Password";
        public static string _alreadyUserRegisteredQuery = "SELECT * FROM UserInfo WHERE EmailAddress = @EmailAddress";
    }
}